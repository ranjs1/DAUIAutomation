...
not_run: GlobalVariable.Meeting = true

CustomKeywords.'com.helper.commonfunct.commonutilities.login'(OPS)

not_run: CustomKeywords.'com.helper.commonfunct.commonutilities.CreateECR'(FileLocation, ORG, ACC, PL, RD, RL, PLTL, DataDrive, 
    TestCaseno, '\\Data Files\\ECR\\TestDataECR.xlsx', '')
...
println(GlobalVariable.Meeting)
