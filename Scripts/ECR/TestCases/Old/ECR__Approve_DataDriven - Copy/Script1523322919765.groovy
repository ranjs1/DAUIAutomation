  ...
  /*  for (int j = 0; j < GlobalVariable.AssignmentList.size(); j++) {*/
        ...
        if (GlobalVariable.Status == 'Pending-RDApproval') {
            ...
            if (GlobalVariable.EXP_SVC_Reject == false) {
                CustomKeywords.'com.helper.commonfunct.commonutilities.login'(EXP)
            ...
            CustomKeywords.'com.helper.commonfunct.commonutilities.EXPReview_RDDReview'()
