...
//String woidForDateExtension = WebUI.callTestCase(findTestCase('Investment/NewInvestmentTestCases/Investment_More_Than_100k'),
//	woid, FailureHandling.STOP_ON_FAILURE)
'As Practice leader extend already existing Investment - Date Only'
CustomKeywords.'da.investment.investmentCommonAction.createDateOnlyInvestment'()

String woid = WebUI.getText(findTestObject('CommonDAObjectRepository/Page_Pega 7/WOID'))

'Details of the Work Object creating during the test Run'
WebUI.comment(woid)
