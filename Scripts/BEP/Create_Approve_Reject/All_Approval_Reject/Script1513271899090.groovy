...
not_run: CustomKeywords.'com.helper.commonfunct.commonutilities.login'(GlobalVariable.URL, GlobalVariable.PL, GlobalVariable.pwd)
...
not_run: CustomKeywords.'com.helper.commonfunct.commonutilities.setprop'('Reject')
